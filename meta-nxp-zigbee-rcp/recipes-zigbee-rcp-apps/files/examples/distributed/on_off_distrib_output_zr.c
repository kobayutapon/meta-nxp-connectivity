...
#error define ZB_DISTRIBUTED_SECURITY_ON to build distributed demo
#endif
 ...
 */
zb_ieee_addr_t g_zr_addr = {0x01, 0x00, 000, 0x00, 0x01, 0x00, 0x00, 0x00}; /* IEEE address of the
                                                                              * device */
...
MAIN()
{
  ...
  ZB_INIT("on_off_distrib_output_zr");
  ...
  zb_bdb_enable_distributed_formation(ZB_TRUE);
...
void test_device_interface_cb(zb_uint8_t param)
{
  ...
  switch (device_cb_param->device_cb_id)
  {
    case ZB_ZCL_SET_ATTR_VALUE_CB_ID:
      ...
      {
        //  WCS_TRACE_INFO("identity time changed to %d", device_cb_param->cb_param.set_attr_value_param.values.data16);
