...
MATTER_APPLICATIONS:append = " ${@bb.utils.contains('MACHINE_FEATURES', 'trusty', " \
    'lighting-app/linux|chip-lighting-app|aarch64-trusty|chip_with_trusty_os=1|chip-lighting-app-trusty' \
    'chip-tool|chip-tool|aarch64-trusty|chip_with_trusty_os=1|chip-tool-trusty' \
    'nxp-thermostat/linux|nxp-thermostat-app|aarch64-trusty|chip_with_trusty_os=1|nxp-thermostat-app-trusty' \
    'nxp-media-app/linux|nxp-media-app|aarch64-trusty|chip_with_trusty_os=1|nxp-media-app-trusty' \
", '', d)}"
